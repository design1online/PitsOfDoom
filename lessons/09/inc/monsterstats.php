...
$monsterid = hasMonster(
	$_SESSION['member']->curcharacter->x,
	$_SESSION['member']->curcharacter->y, 
...
<table width="100%" cellpadding="2" cellspacing="2">
	...
	<tr>
		<td colspan="4" align="center">
			...
			<input type="submit" name="dodge" value="Dodge" />
		<?php
			...
			if ($_SESSION['member']->curcharacter->spell) {
				echo "<input type=\"submit\" name=\"cast\" value=\"Cast\" />";
			}
		?>
		</td>
	</tr>
