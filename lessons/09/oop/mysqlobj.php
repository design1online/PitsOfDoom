...
class database
{
  ...
  var $mysqli;
	...
	**************/
	...
	/**************
	* Purpose: Remove any injections from the input
	* Precondition: value to clean
	* Postcondition: value is returned with injections escaped
	**************/
	function makeClean($value)
	{
		if (is_array($value)) {
			return array_map('self::makeClean',$value);
		} else {
